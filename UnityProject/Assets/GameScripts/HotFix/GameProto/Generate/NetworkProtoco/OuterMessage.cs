...
namespace Fantasy
{
    ...
    [Serializable]
    [ProtoContract]
    public partial class C2B_TestInput : AMessage, IMessage
    {
        public static C2B_TestInput Create(bool autoReturn = true)
        {
            var c2B_TestInput = MessageObjectPool<C2B_TestInput>.Rent();
            c2B_TestInput.AutoReturn = autoReturn;
            
            if (!autoReturn)
            {
                c2B_TestInput.SetIsPool(false);
            }
            
            return c2B_TestInput;
        }
        ...
        public void Dispose()
        {
            if (!IsPool()) return; 
            Seq = default;
            ClientSendTimeMs = default;
            MessageObjectPool<C2B_TestInput>.Return(this);
        }
        public uint OpCode() { return OuterOpcode.C2B_TestInput; } 
        [ProtoMember(1)]
    ...
    [Serializable]
    [ProtoContract]
    public partial class B2C_TestState : AMessage, IMessage
    {
        public static B2C_TestState Create(bool autoReturn = true)
        {
            var b2C_TestState = MessageObjectPool<B2C_TestState>.Rent();
            b2C_TestState.AutoReturn = autoReturn;
            
            if (!autoReturn)
            {
                b2C_TestState.SetIsPool(false);
            }
            
            return b2C_TestState;
        }
        ...
        public void Dispose()
        {
            ...
            Seq = default;
            ClientSendTimeMs = default;
            ServerRecvTimeMs = default;
            ServerSendTimeMs = default;
            MessageObjectPool<B2C_TestState>.Return(this);
        }
        public uint OpCode() { return OuterOpcode.B2C_TestState; } 
        [ProtoMember(1)]
        public uint Seq { get; set; }
        [ProtoMember(2)]
        public long ClientSendTimeMs { get; set; }
        [ProtoMember(3)]
        public long ServerRecvTimeMs { get; set; }
        [ProtoMember(4)]
